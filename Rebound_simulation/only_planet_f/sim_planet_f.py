...
np.savetxt('data/data_without_moon/ecc_planets.txt', ecc)
np.savetxt('data/data_without_moon/sma_planets.txt', sma)
np.savetxt('data/data_without_moon/inc_planets.txt', inc)
np.savetxt('data/data_without_moon/orbital_node_planets.txt', orbital_node)
np.savetxt('data/data_without_moon/omega_planets.txt', omega)
np.savetxt('data/data_without_moon/l_planets.txt', longitude)
