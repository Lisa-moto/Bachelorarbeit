...
np.savetxt(f'data_heavy_planet/ecc_planets_m={m_short:.3f}.txt', ecc)
np.savetxt(f'data_heavy_planet/sma_planets_m={m_short:.3f}.txt', sma)
np.savetxt(f'data_heavy_planet/inc_planets_m={m_short:.3f}.txt', inc)
np.savetxt(f'data_heavy_planet/orbital_node_planets_m={m_short:.3f}.txt', orbital_node)
np.savetxt(f'data_heavy_planet/omega_planets_m={m_short:.3f}.txt', omega)
np.savetxt(f'data_heavy_planet/l_planets_m={m_short:.3f}.txt', longitude)
